...
public class DomainPackageImpl extends EPackageImpl implements DomainPackage {
	 ...
	 * @generated
	 */
	private EClass anschriftEClass = null;
	 ...
	 * @see de.dpa.codingdojo.domain.DomainPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EClass getPerson() {
		if (personEClass == null) {
			personEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(DomainPackage.eNS_URI).getEClassifiers().get(0);
		}
		return personEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getPerson_Anschrift() {
	 ...
	 * @generated
	 */
	public EClass getAnschrift() {
		if (anschriftEClass == null) {
			anschriftEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(DomainPackage.eNS_URI).getEClassifiers().get(1);
		}
		return anschriftEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getAnschrift_Strasse() {
        return (EAttribute)getAnschrift().getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getAnschrift_Hausnummer() {
        return (EAttribute)getAnschrift().getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getAnschrift_Plz() {
        return (EAttribute)getAnschrift().getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getAnschrift_Ort() {
        return (EAttribute)getAnschrift().getEStructuralFeatures().get(3);
	}
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("de.dpa.codingdojo.domain." + eClassifier.getName());
